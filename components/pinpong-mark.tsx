...
export function PinPongMark({
  ...
  return (
    ...
    >
      <span className="absolute inset-0 bg-[radial-gradient(circle_at_72%_26%,rgba(184,237,82,0.45),transparent_22%),linear-gradient(135deg,rgba(255,255,255,0.2),transparent_48%)]" />
      <Icon
        iconNode={batBall}
        className={cn(
          "relative size-6 stroke-[2.35] drop-shadow-[0_2px_2px_rgba(5,60,50,0.32)]",
          animated && "brand-paddle transition-transform duration-300",
        )}
      />
    </span>
  );
